    ...
    render() {
        return (
            <div>
                ...
                <AddressForm placeholder={"Enter the address of a potential home"} includeCommuteOptions={false}/>
                <Button onClick={() => this.scrollToNextStep(this.stepOneEndRef)}>SCROLL</Button>
                <div ref={this.stepOneEndRef}>
                    <h3>Step 2: Enter the addresses of places you want to commute</h3>
                </div>
                <AddressForm placeholder={"Enter the address of a potential commute"} includeCommuteOptions={true}/>
                <Button onClick={() => this.scrollToNextStep(this.stepTwoEndRef)}>SCROLL</Button>
